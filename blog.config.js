...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '帕兰朵', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个诚恳的老司机', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.papaxinxi.cc', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '性息, 楼凤，修车大队，修车，老司机，小姐性息，全国信息，会所，品茶，茶馆，约炮', // 网站关键词 英文逗号隔开
  ...
  POSTS_PER_PAGE: 24, // post counts per page
